...
CREATE TABLE kh_spider_job ( 
	...
	start_time_list      timestamp   ,
	end_time_list        timestamp   ,
	start_time_detail    timestamp   ,
	end_time_detail      timestamp   ,
...
CREATE TABLE kh_user ( 
	...
	create_time          timestamp DEFAULT current_timestamp  ,
	update_time          timestamp DEFAULT current_date  ,
